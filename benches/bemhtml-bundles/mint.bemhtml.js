...
/* begin: ../../desktop.blocks/header/header.bemhtml */
block('header')(
    mix()({ block: 'clearfix' }),
    content()(function() {
        return {
...
/* end: ../../desktop.blocks/header/header.bemhtml */
...
/* begin: ../../libs/bem-components/common.blocks/button/_type/button_type_link.bemhtml */
...
/* end: ../../libs/bem-components/common.blocks/button/_type/button_type_link.bemhtml */


/* begin: ../../desktop.blocks/nav/nav.bemhtml */
block('nav')(
    tag()('ul'),
    elem('item').tag()('li')
);

/* end: ../../desktop.blocks/nav/nav.bemhtml */
...
/* begin: ../../desktop.blocks/first-screen/first-screen.bemhtml */
block('first-screen')(
    mix()({ block: 'clearfix' }),
    content()(function() {
        return {
...
/* end: ../../desktop.blocks/first-screen/first-screen.bemhtml */


/* begin: ../../libs/bl-carousel/desktop.blocks/carousel/carousel.bemhtml */
block('carousel')(
    js()(true)
);

/* end: ../../libs/bl-carousel/desktop.blocks/carousel/carousel.bemhtml */


/* begin: ../../desktop.blocks/carousel/carousel.bemhtml */
block('carousel')(
    // content()(function() {
    //     return {
    //         elem: 'inner',
    ...
    //     };
    // }),
    elem('paginator').mix()({ block: 'clearfix' })
);

/* end: ../../desktop.blocks/carousel/carousel.bemhtml */


/* begin: ../../libs/bl-carousel/desktop.blocks/carousel/__paginator/carousel__paginator.bemhtml */
block('carousel')(
    def()(function() {
        var _this = this,
            items = 0;
...
/* end: ../../libs/bl-carousel/desktop.blocks/carousel/__paginator/carousel__paginator.bemhtml */


/* begin: ../../libs/bl-carousel/desktop.blocks/carousel/__img/carousel__img.bemhtml */
block('carousel').elem('img')(
    tag()('img'),
    attrs()(function() {
        var ctx = this.ctx;
        return {
...
/* end: ../../libs/bl-carousel/desktop.blocks/carousel/__img/carousel__img.bemhtml */
...
/* begin: ../../desktop.blocks/action/action.bemhtml */
block('action')(
    mix()('clearfix'),
    content()(function() {
        return {
    ...
    elem('inner').mix()({ block: 'clearfix' }),
    elem('old').tag()('span')
);

/* end: ../../desktop.blocks/action/action.bemhtml */


/* begin: ../../desktop.blocks/timer/timer.bemhtml */
block('timer').elem('item').tag()('span');
block('timer')(
    js()(true)
);

/* end: ../../desktop.blocks/timer/timer.bemhtml */


/* begin: ../../desktop.blocks/description/description.bemhtml */
block('description').elem('item').tag()('span');

/* end: ../../desktop.blocks/description/description.bemhtml */


/* begin: ../../desktop.blocks/stages/stages.bemhtml */
block('stages').elem('inner').tag()('ol');

/* end: ../../desktop.blocks/stages/stages.bemhtml */


/* begin: ../../desktop.blocks/heading/heading.bemhtml */
block('heading').tag()(function() {
    var mods = this.ctx.mods,
        level = mods && mods.level;

    return 'h' + (level || 1);
});

/* end: ../../desktop.blocks/heading/heading.bemhtml */


/* begin: ../../desktop.blocks/stage/stage.bemhtml */
block('stage').tag()('li');

/* end: ../../desktop.blocks/stage/stage.bemhtml */


/* begin: ../../desktop.blocks/portfolio/portfolio.bemhtml */
...
/* end: ../../desktop.blocks/portfolio/portfolio.bemhtml */


/* begin: ../../desktop.blocks/features/features.bemhtml */
...
/* end: ../../desktop.blocks/features/features.bemhtml */


/* begin: ../../desktop.blocks/price/price.bemhtml */
block('price')(
    content()(function() {
        return {
            elem: 'inner',
...
/* end: ../../desktop.blocks/price/price.bemhtml */


/* begin: ../../desktop.blocks/contacts/contacts.bemhtml */
...
/* end: ../../desktop.blocks/contacts/contacts.bemhtml */
