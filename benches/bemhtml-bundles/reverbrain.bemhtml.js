...
/* begin: ../../common.blocks/page/page.bemhtml */
block('page')(
    js()(true),
    content()(function() {
        return {
...
/* end: ../../common.blocks/page/page.bemhtml */
...
/* begin: ../../common.blocks/section/section.bemhtml */
block('section')(
    attrs()(function() {
        return {
            'data-anchor': this.ctx.mods.type
        };
    }),
    content()(function() {
        return {
...
/* end: ../../common.blocks/section/section.bemhtml */


/* begin: ../../common.blocks/heading/heading.bemhtml */
block('heading').tag()(function() {
    return 'h' + this.ctx.mods.level || 2;
});

/* end: ../../common.blocks/heading/heading.bemhtml */
...
/* begin: ../../common.blocks/slide/slide.bemhtml */
block('slide')(
    attrs()(function() {
        return {
            'data-anchor': this.ctx.mods.type
...
/* end: ../../common.blocks/slide/slide.bemhtml */
