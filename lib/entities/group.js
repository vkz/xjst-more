...
Group.prototype._render = function render() {
  ...
  var branches = this.pairs.map(function(pair, index) {
    ...
    var $test = predV ? '__$t === ' + esgen(predV): '__$t';
    var $cons = esgen({type: 'Program', body: out});
    var $branch = { test: $test, cons: $cons, alt: null};
    // var $cons = out.$branch;
  ...
  result.push(branches.reduceRight(function(prev, next) {
