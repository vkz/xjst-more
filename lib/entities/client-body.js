...
function Body(compiler, body, id, rolledOut, parent) {
  GenericBody.call(this, compiler);
  this.primitive = true;

  if (body instanceof Body || parent) {
    // cloning
    this.id = parent.id;
    this.uid = parent.uid;
...
Body.prototype.clone = function clone() {
  ...
  return new Body(this.compiler, this, undefined, undefined, this);
};
