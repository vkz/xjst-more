...
module.exports = function parameteriseCompiler(preTranslate, _translate) {
...
Compiler.prototype.translateTemplates = function translateTemplates(templates) {
  ...
  var result = this._translate3(program);
...
Compiler.prototype._translate3 = function translate3(program, bodyOnly) {
  var cacheKey = this._renderCacheKey(program.templates);
  var res = this.probeRenderCache(cacheKey);
  if (res && bodyOnly) return xjst.utils.cloneAst(res);
...
// exports.parameteriseCompiler = function(preTranslate, _translate) {
  Compiler.prototype.preTranslate = preTranslate;
  Compiler.prototype._translate = _translate;
  return Compiler;
}
