...
Compiler.prototype.render = function render(program, bodyOnly) {
  var stmts = [],
      ...
      // TODO pre-sanitize program.other before sortGroup? Sanitize replaces
      // this with __$ctx which may then be replaced by bem-xjst
      // replaceContext in post-processing? Could it really? Its bodies of
      // other, so not really templates.
