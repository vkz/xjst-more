...
exports.translateMore = function translateMore(oldTemplates, oldCompiler,
  ...
  var result = oldCompiler.translateTemplates(newTemplates, oldTemplates);
  result.compiler = oldCompiler;
  return result;
}
...
Compiler.prototype.merge = function merge(compiler) {
  ...
  var idMap = {};
  var extensions = compiler.extensions,
      code = compiler.code,
  ...
  // TODO do I need to pass Server options?
