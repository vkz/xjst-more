...
module.exports = function (preTranslate, transformers, renderer) {
  ...
  Compiler.prototype._translate = function _translate(program, bodyOnly) {
    ...
    this.applyTransformers(program);
  ...
  Compiler.prototype.render = function render(program, bodyOnly) {
    ...
    var initializers = this.getInitializers(program, out);
    ...
    var applyBody = this.renderApplyBody(program, out);
  ...
  Compiler.prototype.merge = function merge(compiler) {
    ...
    this.$initializers = this.$initializers.concat(compiler.$initializers);
  ...
  Compiler.prototype.applyTransformers = function (program) {
    transformers
