...
proto.merge =function merge(compiler) {
  var mergeIdMap = {},
...
proto.switchCompilerIn = function switchCompilerIn(templates) {
...
exports.getCompiler = function (preSerialised) {
  var renderer = preSerialised ?
        require("./string-renderer")(proto):
        require("./ast-renderer")(proto);

  var Compiler = getXjstConstructor(proto);
