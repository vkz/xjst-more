...
function switchCompilerIn(templates) {
...
exports.getCompiler = function (preSerialised) {
  ...
  var Compiler = getXjstConstructor(preTranslate, transformers, renderer);
  Compiler.prototype.merge = merge;
  Compiler.prototype.switchCompilerIn = switchCompilerIn;
