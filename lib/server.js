...
var addBemOptions = helpers.addBemOptions;
var bemCompiler = require('bem-xjst').Compiler;
var xjstCompiler = require('./server-xjst').getCompiler(true);
...
Server.prototype.freshCompilers = function freshCompilers() {
  this.result = {};
  this.bemCompiler = new bemCompiler(this.options);
  this.xjstCompiler = new xjstCompiler(this.options);
  return this;
};
