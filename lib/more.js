...
Compiler.prototype.translateMoreAndSend = function translateMoreAndSend(ast, code) {
  ...
  var send = xjst.sendTemplates(ast, code, self.options);
  return function (client) {
    var result = send(client);
    return { ast: self.replaceContext(result.ast),
             ir: result.ir };
  };
};
