...
Compiler.prototype.send = function send(code, client) {
...
Compiler.prototype.sendAndCompile = function sendAndCompile(code, client) {
  var result = this.send(code, client),
      exports = {};
