...
// TODO Server-side
Compiler.prototype.translateMoreAndSend = function translateMoreAndSend(ast, code) {
  var self = this;
  ast = self.pretranslate(ast);
  var packageToSend = xjst.prepareTemplatesForSending(ast, code, self.options);
  return function (client) {
    var templates = packageToSend.templates;
    var compiler = packageToSend.compiler;
...
// Server-side
Compiler.prototype.sendGenerate = function sendGenerate(code, client) {
  var ast = esprima.parse(code, {
    loc: true
  });
...
Compiler.prototype.sendCompile = function sendCompile(code, client) {
