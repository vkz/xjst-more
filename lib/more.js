...
var serverCreateCompiler = require('./server-xjst').create;
var clientCreateCompiler = require('./client-xjst').create;
...
Server.prototype.freshCompilers = function freshCompilers() {
  ...
  this.xjstCompiler = new (serverCreateCompiler(this.preSerialise))(this.options);
  return this;
};
...
function Client(options, state) {
  this.options = options || {};
  this.preSerialise = !!this.options.preSerialise;
  this.templates = [];
  this.code = '';
  this.bemCompiler = new Compiler(options);
  this.xjstCompiler = this.freshXjstCompiler();
...
Client.prototype.freshXjstCompiler = function () {
  return new (clientCreateCompiler(this.preSerialise))(this.options);
};
...
Client.prototype.generate = function generate(message) {
  ...
  this.code = uglify
    .AST_Node
    .from_mozilla_ast({type: "Program", body: ast.body})
...
Client.prototype.unmarshalTemplates = function unmarshalTemplates(data) {
  var constructors = require('./'),
      ...
      compiler = this.freshXjstCompiler(),
