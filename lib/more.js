...
Compiler.prototype.translate = function translate(ast, code, ir) {
  ast = this.pretranslate(ast);
  var result = xjst.translate(ast, code, this.options, ir);
...
Compiler.prototype.generate = function generate(code, ir) {
  ...
  var result = this.translate(ast, code, ir);
...
Compiler.prototype.compile = function compile(code, ir) {
  var result = this.generate(code, ir),
      exports = {};
