...
var xjstServerCompiler = require('./server-xjst').Compiler;
var xjstClientCompiler = require('./client-xjst').Compiler;
...
Server.prototype.freshCompilers = function freshCompilers() {
  ...
  this.xjstCompiler = new xjstServerCompiler(this.options);
  return this;
};
...
function Client(options, state) {
  ...
  this.xjstCompiler = new xjstClientCompiler(options);
...
Client.prototype.unmarshalTemplates = function unmarshalTemplates(data) {
  var constructors = require('./'),
      ...
      compiler = new xjstClientCompiler(),
