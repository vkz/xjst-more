...
Client.prototype.generate = function generate(message) {
  compiler = this.unmarshal(message.compiler);
  ...
  this.html = uglify.AST_Node.from_mozilla_ast(bemxjstResult.ast).print_to_string({ beautify: true });
  return {
    out: this.html,
    ir: bemxjstResult.ir
  }
...
Client.prototype.compile = function compile() {
  var exports = {};
  vm.runInNewContext(this.html, { exports: exports, console: console });
  return exports;
}
