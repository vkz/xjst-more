...
Compiler.prototype.translate = function translate(ast, code, previous) {
  ...
  var result = xjst.translate(ast, code, this.options, previous);
...
Compiler.prototype.generate = function generate(code, previous) {
  // no new templates supplied
  if (!code && previous) return previous;
  ...
  var result = this.translate(ast, code, previous);
